    ...
    <div>
      ...
      <div id="navbar-d" className="fixed lg:flex h-[9vw] w-[100vw] bg-[#000000de] hidden z-[10000] justify-center items-center overflow-x-hidden ">
        ...
        <div className="flex flex-row gap-[2vw] text-white font-body text-[1.3vw] ml-[-9vw] lg:justify-center justify-around  w-screen items-center">
          ...
          <Link to="/products" className=" flex    shadows-text  hover:opacity-70 font-semibold rounded-[0.07rem]  bg   flex-row ml-[1vw]" ><i className=" "><SVG_Spoon_Fork /></i>  ORDER!!</Link>
      ...
      <div id="navbar-m" className={activedBurger === false ? "fixed lg:hidden  h-[10vh]  w-[100vw] bg-[#000000de] flex transition-all delay-75  z-[10000] justify-center items-center overflow-x-hidden " : "fixed lg:hidden transition-all delay-75 h-[70vw] overflow-x-hidden  w-[100vw] bg-[#000000e5] flex  z-[10000] justify-center items-center overflow-hidden "}>
        <div className="flex  flex-row gap-[2vw] text-white font-body text-[1.3vw] ml-[-9vw] lg:justify-center justify-around  w-screen items-center">
          ...
          <div id='mobile-bar' className={activedBurger === false ? "flex w-[50vw]  items-center gap-[1.5vw] transition-all delay-500 opacity-100" : "hidden transition-all delay-500 opacity-0"}>
            ...
            <Link to="/products" className="  lg:visible lg:flex  hidden   shadows-text  hover:opacity-70 font-semibold rounded-[0.07rem]  bg   flex-row ml-[1vw]" ><i className=" "><SVG_Spoon_Fork /></i>  ORDER!!</Link>
        ...
        du Coeur
            ...
            <div className="flex flex-row mr-[1vw]">
              ...
              <Link to="/products" className=" lg:hidden flex   shadows-text text-[4vw]  hover:opacity-70 font-semibold rounded-[0.07rem]  bg   flex-row ml-[1vw]" >
          ...
          <div id='mobile-bar' className={activedBurger === true ? "flex items-center opacity-100 delay-500 transition-all" : "hidden delay-500 transition-all opacity-0"}>
            ...
            <div className=" w-[50vw] h-[65vw] flex flex-col">
              <div className=" flex justify-center items-center  h-[25%]">
              <Link to="/products" onClick={()=>{hamburger();}}  className=" lg:hidden flex   shadows-text text-[4.7vw]  hover:opacity-70 font-semibold rounded-[0.07rem]  bg   flex-row ml-[1vw]" >
