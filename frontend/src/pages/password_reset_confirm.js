  ...
  return (
    ...
    (
      ...
      <p ref={errRef} className={errMsg ? "errmsg" : "offscreen"} aria-live="assertive">{errMsg}</p>
        ...
        <div>
          <label for="html">New Password 1</label>
          <input
...
<p id='pwd1Note' className={!pwd1Valid && pwd1Focus && newPWD1  ? 'instructions' : 'offscreen'}>Password must be at least 7 characters and contain a special and a number</p>
        ...
        <div>
          <label for="html">New Password 2</label>
          <input
        ...
        <button disabled={!pwd2Match || !pwd1Valid || !tokenPWD} type={'submit'}>Submit</button>
